...
export default function Blog() {
  ...
  const handleViewPlayerinfo = (playerName) => {
    navigate(`/playerinfo/${playerName}`);
  };
                    ...
                    <div className="text-sm leading-6">
                      {isAuthorized ? (
                        <div>
                          ...
                          <button style={{marginTop:3}} onClick={handleViewPlayerinfo} className="font-semibold text-white bg-yellow-500 px-3 py-2 rounded-md flex items-center gap-2">
                            View Player Info <IoArrowForwardOutline size={20} />
                          </button>
                        </div>
                      ) : (
                        <button onClick={() => handleViewPlayerinfo(post.playerName)} className="font-semibold text-white bg-yellow-500 px-3 py-2 rounded-md">
                          View Player Info
                        </button>
                      )}
                    </div>
