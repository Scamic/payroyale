...
export default function Adduser() {
  ...
  return (
    <div className="mt-10 max-w-lg mx-auto p-6 bg-gray-900 rounded-lg shadow-lg border border-gray-700">
      <h2 className="text-xl font-bold text-white mb-4">Add Player's Payment Info💵</h2>
      <p className="text-gray-400 mb-6">Enter player details to add  player profile to Clash Royale Payment Gateway.</p>
